...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/11 14:40:49 by flemaist          #+#    #+#             */
/*   Updated: 2017/01/11 14:40:51 by flemaist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	oops_i_did_it_again(char *s, int i, int j)
{
	if (s && s[i])
	{
		ft_putstr_fd("Joshua is confused: ", 2);
		ft_putnbr_fd(j, 2);
		ft_putendl_fd(" bad file descriptor", 2);
	}
	else
	{
		ft_putstr_fd("Joshua is confused: parse error with the redirected \
file: ", 2);
		ft_putendl_fd(s, 2);
	}
}
