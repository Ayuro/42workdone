...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/11 15:12:42 by flemaist          #+#    #+#             */
/*   Updated: 2017/01/11 15:12:43 by flemaist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				check_condition_if(char **arg, int i)
{
	...
	ft_putstr_fd("Joshua is confused: unknown condition: ", 2);
...
int				check_method_two_if(t_e *e, char **arg, int i)
{
	...
	{
		ft_putstr_fd("Joshua is confused: bad pattern: ", 2);
	...
	{
		ft_putstr_fd("Joshua is confused: [: ']' expected\n", 2);
		return (0);
	}
	return (check_between_bracket_if(arg, save, i));
}
