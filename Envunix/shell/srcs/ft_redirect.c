...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/11 14:42:44 by flemaist          #+#    #+#             */
/*   Updated: 2017/01/11 14:42:44 by flemaist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_open_redir(t_e *env, char *s, int fd, char **t)
{
	...
	{
		if (!name)
			ft_putendl_fd("Joshua is confused: parse error near `\\n'", 2);
		else
		{
			ft_putstr_fd("Joshua is confused: file redirection error: ", 2);
