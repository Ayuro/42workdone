...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/01/11 14:43:02 by flemaist          #+#    #+#             */
/*   Updated: 2017/01/11 14:43:03 by flemaist         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_e		*ft_exec(t_e *env, char *s, char **arg, char *tmp)
{
	...
	else if (env && arg && t && t[0])
	{
		if (!(s2 = ft_get_path(env, t[0])))
			quit_error_fd("Joshua is confused: command not found", 2);
